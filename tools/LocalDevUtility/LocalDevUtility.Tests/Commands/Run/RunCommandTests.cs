...
public class RunCommandTests
{
    ...
    [InlineData("run -m r --drex-file-service i", new[] { "cc.rabbitmq-remote", "cc.drex-file-central", "cc.rabbitmq-local", "cc.drex-message-service", "cc.vector-site", "cc.sftp-service", "cc.vector-central", "cc.drex-central-message-service", "cc.drex-file-vessel" })]
